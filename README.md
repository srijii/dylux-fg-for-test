...
### Example
If you have any doubts before installing dylux-bot, try the bot here:
...
3. Scan the QR code using your secondary device.
...
Install the bot with a single click and keep it online 24/7.
